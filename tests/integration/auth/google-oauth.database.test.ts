...
import { OAuthService } from "../../../src/modules/auth/oauth/oauth.service.js";
import type { OAuthClient, OAuthProfile } from "../../../src/modules/auth/oauth/oauth.types.js";
...
class TestGoogleClient implements OAuthClient {
  ...
  async exchangeCode(_code: string, _redirectUri: string): Promise<OAuthProfile> {
    void _code;
    void _redirectUri;
    return this.profile;
  }
...
describe.skipIf(!runDatabaseTests)("Google OAuth", () => {
  ...
  beforeAll(() => {
    ...
    app = createApp({
      ...
      authService,
      googleOAuthService: new OAuthService("GOOGLE", new OAuthRepository(prisma), client),
    });
  });
